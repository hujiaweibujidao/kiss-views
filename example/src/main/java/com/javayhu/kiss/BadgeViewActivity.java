...
import com.javayhu.kiss.views.common.Badge;
...
public class BadgeViewActivity extends AppCompatActivity {
    ...
    private void initBadge() {
        ...
        badge1 = new DraggableBadgeView(this).bindTarget(textview).setDraggable(false);
        badge2 = new DraggableBadgeView(this).bindTarget(imageview);
        badge3 = new DraggableBadgeView(this).bindTarget(button);
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                for (Badge badge : badges) {
                    if (buttonView == swicth_exact) {
                        ...
                        badge2.setOnDragStateChangedListener(isChecked ?
                        ...
                        badge3.setOnDragStateChangedListener(isChecked ?
                                new Badge.OnDragStateChangedListener() {
                                    @Override
                                    public void onDragStateChanged(int dragState, Badge badge, View targetView) {
                                        switch (dragState) {
